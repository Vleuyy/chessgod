...
const repositoryRawURL = 'https://raw.github.com/Vleuyy/chessgod';
const repositoryURL = 'https://github.com/Vleuyy/chessgod';
...
Gui.settings.window.title = 'ChessGod By 6IKM';
...
function addGuiPages() {
    ...
    <div class="rendered-form">
        <div class="card">
            ...
            <div class="card-footer sideways-card">Developers <small>6ikm</small></div>
            <div class="card-footer sideways-card">Version <small>${GM_info.script.version}</small></div>
            <div class="card-footer sideways-card">Repository <a href="${repositoryURL}" target="_blank">chessgod</a></div>
        </div>
    </div>
    `);
}
